...
## Corpus Check
- 176 files · ~188,062 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1610 nodes · 3810 edges · 108 communities (87 shown, 21 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 185 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fa57e904`
...
1. `serverClient()` - 75 edges
2. `cx()` - 58 edges
3. `Card()` - 45 edges
4. `app.audit_trigger()` - 42 edges
5. `money()` - 39 edges
6. `app.has_permission(text)` - 38 edges
7. `Button()` - 37 edges
8. `Badge()` - 37 edges
9. `orders (table)` - 36 edges
...
Cohesion: 0.11
Nodes (45): AddOnRow, metadata, Address, metadata, CatalogNav(), TABS, ActionFeedback(), done() (+37 more)

### Community 1 - "Community 1"
Cohesion: 0.18
Nodes (14): can(), requireAnyPermission(), CustomerDetailPage(), CustomerRow, CustomersPage(), metadata, SOURCE_LABELS, EmployeesPage() (+6 more)
...
Cohesion: 0.17
Nodes (14): CashfreeAdapter, environmentFromKey(), signaturesMatch(), adapters, availablePaymentProviders(), DISPLAY_NAMES, CreateOrderResult, PaymentAdapter (+6 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (48): DailyRow, SOURCE_FILL, SOURCE_ORDER, HistoryScope, HistoryTicket, INITIAL, keyOf(), State (+40 more)
...
Cohesion: 0.10
Nodes (31): CheckoutDraft, draftSchema, saveDraft(), CATALOG_TAGS, CategoryGroup, CollectionSummary, DeliveryWindow, getPlan() (+23 more)
...
Cohesion: 0.09
Nodes (45): AccountPage(), metadata, SubscriptionControls(), AdminOverviewPage(), DailyRow, DashboardRow, metadata, RevenueChart() (+37 more)
...
Cohesion: 0.19
Nodes (16): clearDraft(), beginCheckout(), BeginResult, confirmCheckout(), ConfirmOutcome, bodySchema, POST(), marketplaceAdapter() (+8 more)
...
Cohesion: 0.10
Nodes (25): ACTION_TONE, AuditRow, metadata, AppRole, Permission, PERMISSIONS, STAFF_ROLES, SessionProfile (+17 more)
...
Cohesion: 0.20
Nodes (10): bodySchema, POST(), readDraft(), ensureCustomer(), configuredPaymentProviders(), serverEnv, serverSchema, config (+2 more)
...
Cohesion: 0.07
Nodes (35): CopyButton(), DemoAccount, DemoAccountList, DemoAccounts(), demoAccountsEnabled(), explainAbsence(), listDemoAccounts(), ROLE_LABELS (+27 more)
...
Cohesion: 0.08
Nodes (22): Courier(), DeliveryRun(), DriftingArrow(), DriftingPhoto(), HeroLayer(), HeroScrollContext, HeroStage(), LIFT_SPRING (+14 more)

### Community 65 - "Community 65"
Cohesion: 0.29
Nodes (3): RazorpayAdapter, signaturesMatch(), CreateOrderInput
...
Cohesion: 0.33
Nodes (5): STATUS_NOTE, WITHDRAWABLE, metadata, RequestRow, STATUS_TONES
...
## Knowledge Gaps
- **390 isolated node(s):** `eslintConfig`, `nextConfig`, `name`, `version`, `private` (+385 more)
